...
namespace inonego.Xeri.UI.Game
{
    // ============================================================
    /// <summary>
    /// 여러 사각 구멍을 지원하는 UGUI Focus Highlight Graphic.
    /// </summary>
    // ============================================================
    public sealed class UGUIFocusHighlightGraphic : MaskableGraphic, ICanvasRaycastFilter
    {
    #region 필드

        // ------------------------------------------------------------
        /// <summary>
        /// 현재 Focus Highlight 구멍 수.
        /// </summary>
        // ------------------------------------------------------------
    ...
    #region 메서드
        ...
        // ------------------------------------------------------------
        /// <summary>
        /// 지정 위치가 하나 이상의 Highlight 구멍 안에 있는지 확인한다.
        /// </summary>
        // ------------------------------------------------------------
