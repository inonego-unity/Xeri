...
namespace inonego.Xeri.UI.Picker
{
    ...
    #region 생성
        ...
        /// </summary>
        // ----------------------------------------------------------------------
        public static PickerSpecBuilder<KeyValuePair<TKey, TValue>, KeyValuePair<TKey, TValue>> PairSpec<TKey, TValue>(string title)
        {
    ...
    #region 메서드
        ...
        /// </summary>
        // ------------------------------------------------------------
        public static IReadOnlyList<KeyValuePair<TKey, TValue>> Entries<TKey, TValue>(IReadOnlyDictionary<TKey, TValue> dictionary)
        {
