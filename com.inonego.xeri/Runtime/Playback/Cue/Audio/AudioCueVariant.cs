/* BLOCK_HEADER_BEGIN =======================================================================
파일명 : AudioCueVariant.cs
수정일 : 2026-09-05

# 설명
Audio Cue Variant가 공통으로 사용하는 authoring 재생 설정을 정의한다.
...
namespace inonego.Xeri.Playback
{
    // ============================================================
    /// <summary>
    /// Audio Cue Variant의 공통 재생 설정.
    /// </summary>
    // ============================================================
    [Serializable]
    public abstract class AudioCueVariant
    {
    ...
    #region 필드
        ...
        /// <summary>
        /// <br/> Cue의 기본 재생 Pitch.
        /// <br/> Unity AudioClip 범위인 -3 이상 3 이하를 사용한다.
        /// </summary>
        // ----------------------------------------------------------------------
        public float Pitch
        {
